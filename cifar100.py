...
def inference(images):
  ...
  with tf.variable_scope('hidden1') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden1 = tf.nn.relu(tf.matmul(local3, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden6') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden6 = tf.nn.relu(tf.matmul(hidden5, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden7') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden7 = tf.nn.relu(tf.matmul(hidden6, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden8') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden8 = tf.nn.relu(tf.matmul(hidden7, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden9') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden9 = tf.nn.relu(tf.matmul(hidden8, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden10') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden10 = tf.nn.relu(tf.matmul(hidden9, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden11') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden11 = tf.nn.relu(tf.matmul(hidden10, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden12') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden12 = tf.nn.relu(tf.matmul(hidden11, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden13') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden13 = tf.nn.relu(tf.matmul(hidden12, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden14') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden14 = tf.nn.relu(tf.matmul(hidden13, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden15') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden15 = tf.nn.relu(tf.matmul(hidden14, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden16') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden16 = tf.nn.relu(tf.matmul(hidden15, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden17') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden17 = tf.nn.relu(tf.matmul(hidden16, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden18') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden18 = tf.nn.relu(tf.matmul(hidden17, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden19') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden19 = tf.nn.relu(tf.matmul(hidden18, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden20') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden20 = tf.nn.relu(tf.matmul(hidden19, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden21') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden21 = tf.nn.relu(tf.matmul(hidden20, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden22') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden22 = tf.nn.relu(tf.matmul(hidden21, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden23') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden23 = tf.nn.relu(tf.matmul(hidden22, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden24') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden24 = tf.nn.relu(tf.matmul(hidden23, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden25') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden25 = tf.nn.relu(tf.matmul(hidden24, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden26') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden26 = tf.nn.relu(tf.matmul(hidden25, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden27') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden27 = tf.nn.relu(tf.matmul(hidden26, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden28') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden28 = tf.nn.relu(tf.matmul(hidden27, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden29') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden29 = tf.nn.relu(tf.matmul(hidden28, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('hidden30') as scope:
    ...
    weights = _variable_with_weight_decay('weights', shape=[384, 384],
                                          stddev=0.04, wd=0.004)
    biases = _variable_on_cpu('biases', [384], tf.constant_initializer(0.1))
    hidden30 = tf.nn.relu(tf.matmul(hidden29, weights) + biases, name=scope.name)
  ...
  with tf.variable_scope('local4') as scope:
    ...
    local4 = tf.nn.relu(tf.matmul(hidden30, weights) + biases, name=scope.name)
